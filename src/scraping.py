...
def banner():
    ...
    print(
        "\033[31m"
        + r"  __      __      ___.       _________                          .__                   "
        + "\033[0m"
    )
    print(
        "\033[31m"
        + r" /  \    /  \ ____\_ |__    /   _____/ ________________  ______ |__| ____    ____     "
        + "\033[0m"
    )
    print(
        "\033[31m"
        + r" \   \/\/   // __ \| __ \   \_____  \_/ ___\_  __ \__  \ \____ \|  |/    \  / ___\    "
        + "\033[0m"
    )
    print(
        "\033[31m"
    ...
    print(
        "\033[31m"
        + r"   \__/\  /  \___  >___  / /_______  /\___  >__|  (____  /   __/|__|___|  /\___  /    "
        + "\033[0m"
    )
    print(
        "\033[31m"
...
def verificar_disponibilidad():
    ...
    descripcion = (
        meta_desc.get("content", "Sin descripción") if meta_desc else "Sin descripción"
    )
    ...
    print(
        f"   📈 Total de enlaces: {len(enlaces_internos) + len(enlaces_externos) + len(enlaces_relativos)}"
    )
